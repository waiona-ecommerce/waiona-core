...
<head>
  ...
  <title>Recuperá tu contraseña en Waiona</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="color:${EMAIL_THEME.colors.text};line-height:1.6;margin:0 0 24px;">
                Recibimos una solicitud para restablecer la contraseña de tu cuenta en Waiona. Si fuiste vos, hacé clic en el botón de abajo.
              </p>
              ...
              <p style="font-size:12px;color:#666;margin:0;">
                Este link expira en <strong>1 hora</strong>. Si no solicitaste recuperar tu contraseña, ignorá este email — tu cuenta está segura.
              </p>
            </td>
          </tr>
