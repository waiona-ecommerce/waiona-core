...
export class ComboImageController {
  ...
  @ApiResponse({ status: 201, description: 'Imagen creada', type: ComboImageResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Imágenes del combo', type: ComboImageResponseDto, isArray: true })
  findByCombo(
  ...
  @ApiResponse({ status: 200, description: 'Imagen encontrada', type: ComboImageResponseDto })
  ...
  @ApiParam({ name: 'id', type: Number })
  @ApiResponse({ status: 200, description: 'Imagen actualizada', type: ComboImageResponseDto })
  @ApiResponse({ status: 404, description: 'Imagen no encontrada' })
  update(
    @Param('id', ParseIntPipe) id: number,
